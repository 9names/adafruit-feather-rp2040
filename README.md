...
[adafruit-feather-rp2040]: https://github.com/rp-rs/adafruit-feather-rp2040
...
```console
adafruit-feather-rp2040 $ cargo build --release --example <name>
```
...
```console
adafruit-feather-rp2040 $ cargo run --release --example <name>
```
...
6. Create a [New Pull Request](https://github.com/rp-rs/adafruit-feather-rp2040/pulls)
